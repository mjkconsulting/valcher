...
<h2>Get Gemz Messages</h2>
	...
	<li>Access URL: {html func=link title="$server/$path/getGemzMessages/1/" url="#"} [REST]</li>
	<li>e.g: {$server}/{$path}/getGemzMessages/1</li>
