...
<a name="getDeals"></a>
<h2>GetDeals Service</h2>
	<li>Fetches all the deals for a user</li>
	<li>Access URL: {html func=link title="$server/$path/getDeals/" url="#"} [REST]</li>
	<li>e.g: {$server}/{$path}/getDeals/1</li>
...
{/literal}
	...
	<table class="plain" cellpadding="2" border="0" width="450px">
		...
		<tr><td>$user_id</td><td>Int</td><td>&nbsp;</td></tr>
