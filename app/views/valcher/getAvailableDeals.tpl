...
<h2>GetAvailableDeals service</h2>
	...
	<li>Access URL: {html func=link title="$server/$path/getAvailableDeals/userid/" url="#"} [REST]</li>
	<li>e.g: {$server}/{$path}/getAvailableDeals/1</li>
