<?php /* Smarty version 2.6.26, created on 2010-12-22 19:05:10
         compiled from ../views/valcher/getDealByDate.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html', '../views/valcher/getDealByDate.tpl', 8, false),)), $this); ?>

<a name="getDealByDate"></a>
<h2>GetDealByDate Service</h2>
	<li>Fetches the daily deal per a given date</li>
	<li>Access URL: <?php echo $this->_plugins['function']['html'][0][0]->html(array('func' => 'link','title' => ($this->_tpl_vars['server'])."/".($this->_tpl_vars['path'])."/getDealByDate/",'url' => "#"), $this);?>
 [REST]</li>
	<li>e.g: <?php echo $this->_tpl_vars['server']; ?>
/<?php echo $this->_tpl_vars['path']; ?>
/getDealByDate/2010-11-25</li>
