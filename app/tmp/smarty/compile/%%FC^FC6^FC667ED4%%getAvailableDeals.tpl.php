<?php /* Smarty version 2.6.26, created on 2010-12-16 12:29:23
         compiled from ../views/valcher/getAvailableDeals.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html', '../views/valcher/getAvailableDeals.tpl', 8, false),)), $this); ?>

<a name="getAvailableDeals"></a>
<h2>GetAvailableDeals service</h2>
	<li>Gets Available deals for a user</li>
	<li>Access URL: <?php echo $this->_plugins['function']['html'][0][0]->html(array('func' => 'link','title' => ($this->_tpl_vars['server'])."/".($this->_tpl_vars['path'])."/getAvailableDeals/userid/",'url' => "#"), $this);?>
 [REST]</li>
	<li>e.g: <?php echo $this->_tpl_vars['server']; ?>
/<?php echo $this->_tpl_vars['path']; ?>
/getAvailableDeals/1</li>
...
<br/>
	...
	<table class="plain" cellpadding="2" border="0" width="450px">
		...
		<tr><td>Includes deal purchased in a separate element</td><td></td><td></td></tr>
	</table>
	'; ?>
