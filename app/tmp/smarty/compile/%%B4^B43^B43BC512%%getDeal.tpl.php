<?php /* Smarty version 2.6.26, created on 2010-12-14 17:29:24
         compiled from ../views/valcher/getDeal.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html', '../views/valcher/getDeal.tpl', 8, false),)), $this); ?>

<a name="getDeal"></a>
<h2>GetDeal Service</h2>
	<li>Fetches Deal Data</li>
	<li>Access URL: <?php echo $this->_plugins['function']['html'][0][0]->html(array('func' => 'link','title' => ($this->_tpl_vars['server'])."/".($this->_tpl_vars['path'])."/getDeal/",'url' => "#"), $this);?>
 [REST]</li>
