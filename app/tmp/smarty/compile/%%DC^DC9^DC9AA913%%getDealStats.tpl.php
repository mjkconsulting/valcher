<?php /* Smarty version 2.6.26, created on 2010-12-22 18:58:12
         compiled from ../views/valcher/getDealStats.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html', '../views/valcher/getDealStats.tpl', 8, false),)), $this); ?>

<a name="getDealStats"></a>
<h2>GetDealStats Service</h2>
	<li>Fetches Deal Stats</li>
	<li>Access URL: <?php echo $this->_plugins['function']['html'][0][0]->html(array('func' => 'link','title' => ($this->_tpl_vars['server'])."/".($this->_tpl_vars['path'])."/getDealStats/",'url' => "#"), $this);?>
 [REST]</li>
