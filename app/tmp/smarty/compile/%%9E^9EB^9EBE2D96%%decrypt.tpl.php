<?php /* Smarty version 2.6.26, created on 2010-12-22 18:58:12
         compiled from ../views/valcher/decrypt.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html', '../views/valcher/decrypt.tpl', 9, false),)), $this); ?>

<?php $this->assign('name', 'unsecret'); ?>
<a name="<?php echo $this->_tpl_vars['name']; ?>
"></a>
<h2><?php echo $this->_tpl_vars['name']; ?>
 Service</h2>
	<li>Decrypts a string (simple)</li>
...
/?string=51aBc123YzUnmE60aBc123YzUnmE59</li>
	<table class="plain" cellpadding="2" border="0" width="450px">
		<tr><th>Returns</th><th>Data Type</th><th>Comment</th></tr>
		<tr><td>String</td><td>String</td><td>The decrypted string</td></tr>
	</table>
	<table class="plain">
