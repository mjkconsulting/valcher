<?php /* Smarty version 2.6.26, created on 2010-12-16 12:29:23
         compiled from ../views/valcher/getDeals.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html', '../views/valcher/getDeals.tpl', 8, false),)), $this); ?>

<a name="getDeals"></a>
<h2>GetDeals Service</h2>
	<li>Fetches all the deals for a user</li>
	<li>Access URL: <?php echo $this->_plugins['function']['html'][0][0]->html(array('func' => 'link','title' => ($this->_tpl_vars['server'])."/".($this->_tpl_vars['path'])."/getDeals/",'url' => "#"), $this);?>
 [REST]</li>
