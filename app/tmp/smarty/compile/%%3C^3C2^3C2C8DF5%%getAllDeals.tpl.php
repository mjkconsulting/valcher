<?php /* Smarty version 2.6.26, created on 2010-12-23 15:15:25
         compiled from ../views/valcher/getAllDeals.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html', '../views/valcher/getAllDeals.tpl', 8, false),)), $this); ?>

<a name="getAllDeals"></a>
<h2>GetAllDeals Service</h2>
	<li>Fetches all the deals</li>
	<li>Access URL: <?php echo $this->_plugins['function']['html'][0][0]->html(array('func' => 'link','title' => ($this->_tpl_vars['server'])."/".($this->_tpl_vars['path'])."/getAllDeals/",'url' => "#"), $this);?>
 [REST]</li>
